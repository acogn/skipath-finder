...
def create_les_arcs_graph():
    ...
    slopes = [
        ...
        ("Grizzly top", "Le Derby Bottom", 1.4, 'red', "Myrtilles bovenste stuk"),
        ("La Bulle Restaurant", "Arc 1950", 1.25, 'blue', "Vallee De L'Arc 1 bovenstuk"),
        ("Arc 1950", "Comborciere Bottom", 1.25, 'blue', "Vallee De L'Arc 1 onderstuk"),
        ("Comborciere Top", "Mont Blanc Top", 0.3, 'blue', "Belvedere 4"),
        ("Le Derby Top", "Le Derby Bottom", 1.2, 'red', "Belette"), #naar boven afgerond omdat belette niet volledig is
        ...
        ("Le Derby Bottom", "Vallandry", 1.1+1.2, 'blue', "Myrtille onderste + barmont"),
        ("Mont Blanc Top", "Arc 1600", 3.7, 'blue', "Mont Blanc slope"),
        ("Mont Blanc Top", "Arc 1600", 3.6, 'red', "Arolles slope"),
        ("Bois de l'Ours Top", "Le Derby Bottom", 5, 'blue', "Arpette naar Le Derby")
    ]
